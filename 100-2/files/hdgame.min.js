if (typeof HdGame == "undefined") {
    ...
    b.getGameRule = (function() {
        ...
        return function(g, f) {
            ...
            (function() {
                var j = '{"rt":0,"success":true,"data":{"info":"{"startTime":1514452540074,"flow":2120244043,"rule":{"xList":[7.9635,8.5403,8.8815,4.8513,6.9151,9.3315,3.8078,4.8767,0.4813,5.2452,8.8299,5.1436,2.8096,8.5115,6.2842,4.1169,8.7432,4.2437,8.0626,6.0647,3.3333,0.8902,7.7694,6.5246,7.6756,6.1773,2.9421,8.73,10.3504,9.4859,8.8457,0.6003,8.6321,3.63,3.4068,1.1434,5.4835,5.1033,0.1137,2.6997,0.1504,5.5387,7.6738,4.359,5.4211,7.8821,3.3822,8.1143,7.3251,2.1165,3.5312,8.8809,4.6998,9.2843,5.7561,1.3936,7.6694,3.5476,2.4945,8.7159,7.1428,6.5934,4.2116,3.639,0.4566,4.84,0.2279,7.1213,3.2601,3.623,2.8701,0.6224,4.1627,4.8453,0.7556,7.2137,5.5437,1.9557,7.3098,7.7073,0.7525,0.0791,3.1143,3.229,4.2129,9.6612,10.3771,5.1772,5.6803,2.6039,9.2209,1.3507,2.5927,2.5643,8.5863,5.1989,4.0972,7.8577,9.3569,7.1469],"cWidth":5.5,"jWidth":4.0}}","sign":"6ad6e7b11682506035633f6caae8fbe6"},"msg":"操作成功"}';
                var h = $.parseJSON(j);
                if (h.success) {
                    _ruleInfo.rule = h.data;
                    if (typeof _ruleInfo.rule.info == "string") {
