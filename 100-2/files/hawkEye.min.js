...
window.FAI_HAWK_EYE.FAI_HAWK_EYE_REPORT_URL = window.FAI_HAWK_EYE.jssdk_report_url;
(function (a, b) {
    a._DEF = {
        _MODULE: {
            _TYPE: {
...
(function (e, k, c) {
    ...
    function g(l, m) {
        ...
        this._init = function () {
            ...
            if (e.addEventListener) {
                e.addEventListener("error", function (q) {
                    var r = {};
    ...
    function f(l, m) {
        ...
        this._init = function () {
            var o = this;
            if ( !! e.addEventListener) {
                e.addEventListener("load", function (p) {
                    setTimeout(function () {
                        var q = n();
                        o.report(q, o._type)
                    }, 100)
                ...
                if ( !! e.attachEvent) {
                    e.attachEvent("onload", function (p) {
                        setTimeout(function () {
                            var q = n();
                            o.report(q, o._type)
                        }, 100)
    ...
    function b(l, m) {
        ...
        this._init = function () {
            ...
            if (e.addEventListener) {
                ...
                e.addEventListener("dblclick", function (r) {
                    q = false;
                    clearTimeout(p);
                    n(r)
                })
                ...
                if (e.attachEvent) {
                    var q = true;
                    var p = null;
                    document.attachEvent("onclick", function (r) {
                        q = true;
                        var s = {};
                        s.src = r.srcElement;
                        s.screenX = r.screenX;
                    ...
                    document.attachEvent("ondblclick", function (r) {
                        q = false;
                        clearTimeout(p);
                        n(r)
                    })
    ...
    function d(p, q) {
        ...
        this._init = function () {
            ...
            if (false) {
                if ( !! e.addEventListener) {
                    e.addEventListener("load", function (v) {
                        setTimeout(function () {
                            r()
                        }, 1000)
                    }, false)
        ...
        function l() {
            ...
            var u = new Date();
            var t = u.getTime();
            v.url = "//t2.faisco.cn/tsd.gif?t=" + t;
            v.size = 103988;
            v.type = 0;
            s.push(v);
            v = {};
            v.url = "//t4.faisco.cn/tsd.gif?t=" + t;
            v.type = 0;
            v.size = 103988;
            s.push(v);
            v = {};
            v.url = "//t4.faisco.cn/tsu.gif?t=" + t;
            v.type = 1;
            v.size = 51200;
            s.push(v);
            v = {};
            v.url = "//t1.faisco.cn/tsd.gif?t=" + t;
            v.size = 103988;
            v.type = 0;
            s.push(v);
            v = {};
            v.url = "//t3.faisco.cn/tsd.gif?t=" + t;
            v.type = 0;
            v.size = 103988;
            s.push(v);
            v = {};
            v.url = "//t3.faisco.cn/tsu.gif?t=" + t;
            v.type = 1;
            v.size = 51200;
            s.push(v);
            return s
